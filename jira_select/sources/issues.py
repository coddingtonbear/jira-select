...
from ..exceptions import QueryError, ExpressionParameterMissing
...
class Source(BaseSource):
    ...
    def _get_jql(self) -> str:
        ...
        if missing := find_missing_parameters(query, list(self._executor.parameters.keys())):
        ...
        query = query.format(
            params=DotMap(self._executor.parameters)
        )
